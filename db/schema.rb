...
ActiveRecord::Schema.define(version: 2020_04_09_015450) do
  ...
  create_table "type_pals", force: :cascade do |t|
    t.bigint "pocket_pal_id", null: false
    t.bigint "type_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["pocket_pal_id"], name: "index_type_pals_on_pocket_pal_id"
    t.index ["type_id"], name: "index_type_pals_on_type_id"
  end
  ...
  add_foreign_key "type_pals", "pocket_pals"
  add_foreign_key "type_pals", "types"
end
